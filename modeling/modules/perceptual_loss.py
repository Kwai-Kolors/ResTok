# Modified from:
#   TiTok: https://github.com/bytedance/1d-tokenizer/blob/main/modeling/modules/perceptual_loss.py
...
class PerceptualLoss(torch.nn.Module):
    ...
    def forward(self, input: torch.Tensor, target: torch.Tensor, training: bool = False):
        ...
        if self.lpips is not None:
            ...
            lpips_loss = self.lpips(*padding_and_trimming(input, target, training))
