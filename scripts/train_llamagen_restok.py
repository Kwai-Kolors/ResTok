...
from utils.train_utils import (
    get_config, create_model_and_loss_module, get_restok_tokenizer,
...
def main():
    ...
    logger = setup_logger(name="ResTok-LlamaGen", log_level="INFO",
    ...
    tokenizer = get_restok_tokenizer(config)
    ...
    logger.info(f"  Early stop steps = {config.training.get('early_stop_steps', config.training.max_train_steps)}")
    ...
    for current_epoch in range(first_epoch, num_train_epochs):
        ...
        if config.dataset.params.get("pretokenization", ""):
            train_dataloader.set_epoch(current_epoch)
